...
def single_run(data, data_target, iterations, pipeline, result_dict, test, train):
    ...
    result_dict['roc_auc_ovo_weighted'] = series_combiner(result_dict['roc_auc_ovo_weighted'], pd.Series(
        roc_auc_score(y_true=y_test, y_score=y_prob[:, 1], ),
...
if __name__ == '__main__':
    ...
    root = "/home/ubuntu/atsfp/atsfp-23-24/data/fst_with_binaryclass/"
    ...
    vocabulary_processed_data["flaky"] = vocabulary_processed_data["flaky"].map(lambda x : "NOT_FLAKY" if x == 0 else "FLAKY" )
